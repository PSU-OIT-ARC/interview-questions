...
class QuestionSearchForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['order'].initial = QuestionOrderChoices.CREATED_ON
    ...
    def search(self):
        ...
        if self.is_bound and self.is_valid() and self.cleaned_data.get("order"):
            ...
            elif self.cleaned_data['order'] == str(QuestionOrderChoices.CREATED_ON):
                questions = questions.order_by('-created_on')

            #elif self.cleaned_data['order'] == str(QuestionOrderChoices.CREATED_BY):
                #questions = questions.order_by('created_by')

            elif self.cleaned_data['order'] == str(QuestionOrderChoices.DIFFICULTY):
...
class QuestionForm(forms.ModelForm):
    ...
    """
    tags = forms.CharField(required=False, label="")
    ...
    def clean_difficulty(self):
        """
        Ensures difficulty is from 0-5
        """
    ...
    def clean_tags(self):
        """
        Clean tags associated with the question
        """
